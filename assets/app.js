...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Hero video mute/unmute toggle — starts muted (required for autoplay to
  // work in any browser); tapping the subtle icon lets the visitor turn sound on.
  ...
  if (heroVideo && heroMuteToggle) {
    heroMuteToggle.addEventListener('click', () => {
      ...
      heroMuteToggle.textContent = heroVideo.muted ? '🔇' : '🔊';
